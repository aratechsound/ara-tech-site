...
assert.doesNotMatch(commercial, /iframe/u, 'related materials no longer use a blob iframe');
assert.doesNotMatch(commercial, /createObjectURL/u, 'thumbnail rendering no longer depends on blob URLs');
