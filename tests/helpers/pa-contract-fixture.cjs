...
async function createFixture(){
 ...
 const rawMessage=(id='direct_sent_001')=>({id,threadId:'thread_123',labelIds:['SENT'],internalDate:'1788254400000',payload:{mimeType:'multipart/mixed',headers:[{name:'From',value:'aratechsound@gmail.com'},{name:'To',value:'customer@example.invalid'},{name:'Cc',value:'venue@example.invalid'},{name:'Subject',value:'PA-20260907-00001 / Event estimate'},{name:'Message-ID',value:'<fixture@example.invalid>'}],parts:[{mimeType:'text/plain',body:{data:Buffer.from('Fixture estimate message').toString('base64url')}},{mimeType:'application/pdf',filename:'____.pdf',partId:'1',headers:[{name:'Content-Disposition',value:"attachment; filename=\"____.pdf\"; filename*=UTF-8''%E8%A6%8B%E7%A9%8D%E6%9B%B8%202026.10.18%20%E9%BE%8D%E5%A7%AB%E6%B9%96%E3%81%BE%E3%81%A4%E3%82%8A.pdf"}],body:{attachmentId:'attachment_1',size:state.quote.length}}]}});
