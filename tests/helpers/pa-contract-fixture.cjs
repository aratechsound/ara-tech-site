...
async function createFixture(){
 ...
 update public.pa_gmail_message_index set to_addresses='["customer@example.invalid"]',cc_addresses='["venue@example.invalid"]',attachment_metadata='[{"id":"attachment_1","filename":"final-estimate.pdf","mime_type":"application/pdf"}]';`);
