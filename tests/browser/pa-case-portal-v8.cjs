...
<section class="hero"><div class="hero-copy"><span class="kicker">EVENT DOCUMENT PORTAL</span><h1>2026龍姫湖まつり</h1><p>イベント運営資料の最新版と履歴を確認できます。</p></div><dl class="event-meta"><div><dt>開催日</dt><dd>2026年10月18日</dd></div><div><dt>本番時間</dt><dd>10:00〜15:00</dd></div><div><dt>会場</dt><dd>温井ダム堤体横駐車場</dd></div></dl></section>
