...
<header class="portal-header"><div class="header-inner"><div class="brand"><img src="/img/ARA-TECH%20ロゴ横%20白.png" alt="ARA-TECH"></div></div></header>
<main class="portal-shell"><section id="portal">
<section class="hero"><div class="hero-copy"><span class="kicker">EVENT DOCUMENT PORTAL</span><h1>2026龍姫湖まつり</h1><p>イベント運営資料の最新版と履歴を確認できます。</p></div><dl class="event-meta"><div><dt>開催日</dt><dd>2026年10月18日</dd></div><div><dt>本番時間</dt><dd>10:00〜15:30</dd></div><div><dt>会場</dt><dd>温井ダム堤体横駐車場</dd></div></dl></section>
