...
const portalVersions = [{ id: 'version-1', card_id: 'card-1', source_ref: { gmail_message_id: 'm2', gmail_attachment_id: 'a2' }, display_filename: '会場図.pdf', mime_type: 'application/pdf', contributor_kind: 'organizer', source_created_at: '2026-09-12T01:00:00Z' }];
const portalPhotos = [{ id: 'photo-1', source_ref: { gmail_message_id: 'm3', gmail_attachment_id: 'a3' }, display_filename: 'ステージ写真.JPG', mime_type: 'image/jpeg', contributor_kind: 'organizer', source_created_at: '2026-09-11T01:00:00Z' }];
const gmailMessages = [{ gmail_message_id: 'm1', direction: 'outbound', sent_at: '2026-09-13T01:00:00Z', attachment_metadata: [{ id: 'a1', filename: '見積書.pdf', mime_type: 'application/pdf' }] },
  { gmail_message_id: 'm2', direction: 'inbound', received_at: '2026-09-12T01:00:00Z', attachment_metadata: [{ id: 'a2', filename: '会場図.pdf', mime_type: 'application/pdf' }] },
  { gmail_message_id: 'm3', direction: 'inbound', received_at: '2026-09-11T01:00:00Z', attachment_metadata: [{ id: 'a3', filename: 'ステージ写真.JPG', mime_type: 'image/jpeg', size: 50000 }, { id: 'logo', filename: 'signature-logo.png', mime_type: 'image/png', size: 400 }] },
